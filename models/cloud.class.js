class Cloud extends MovableObject {
    ...
    constructor(imagePath, x) {                                                                   // super() wird verwendet, wenn wir Methoden von einem übergeordneten Element aufrufen wollen.                                                                      
        // super().loadImage('img/5.Fondo/Capas/4.nubes/1.png');
        super().loadImage(imagePath, x);

        this.x = x + Math.random() * 500;                                                 // X-Koordinate wird zufällig Pixel abgeändert.  //Math.random = zufällige Zahl zw. 0 & 1 
